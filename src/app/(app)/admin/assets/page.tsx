      ...
      <header className="relative overflow-hidden rounded-[2rem] glass-strong shadow-[0_32px_128px_rgba(0,0,0,0.5)] border border-white/10 p-8">
        ...
        <div className="relative flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          <div className="flex items-center gap-5">
            <div className="h-14 w-14 rounded-2xl bg-gradient-to-br from-indigo-500/20 to-purple-500/20 flex items-center justify-center border border-white/15 shadow-xl backdrop-blur-md">
              <Package className="h-8 w-8 text-indigo-300" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <ShieldCheck className="h-3.5 w-3.5 text-indigo-400" />
                <span className="text-[10px] font-bold tracking-[0.2em] text-indigo-400/80 uppercase">Control Center</span>
              </div>
              <h1 className="text-3xl font-bold tracking-tight text-white/95 mt-0.5">Asset Management</h1>
            </div>
          </div>
